...
EPOCH16 = ++trainer.train.epochs=16
...
#
# pubtabnet finetuning
#

# table bbox (task code: bbox) for Training
TRAIN_pub_bbox := $(VOCAB_BBOX) \
	$(PUBTABNET) $(LABEL_BBOX) $(AUG_RESIZE_NORM) \
	$(TRAINER_TABLE) $(I448) $(SEQ1024) \
	$(EPOCH16) $(OPT_ADAMW) $(OPT_WD5e2) $(LR_3e4) $(GRAD_CLIP12)

BATCH28  = ++trainer.train.dataloader.batch_size=28 ++trainer.valid.dataloader.batch_size=28
EXP_ssp_2m_pub_bbox_base := $(TRAIN_pub_bbox) $(ARCH_BASE) \
	$(WEIGHTS_mtim_2m_base) $(LOCK_MTIM_4) $(BATCH28) $(LR_cosine216k_warm27k)

# table bbox (task code: bbox) for eval
...
EXP_ssp_2m_pub_bbox_val := $(TEST_pub_bbox) $(ARCH_BASE) $(BATCH96)